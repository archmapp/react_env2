...
export const qcL = (sel, cN = 'is-active', mN = 'toggle') =>
	...
	/* class="pageloader" bulma-pageloader in bulma-extensions.min.css */
	/* class="pageloader is-right-to-left" */
export const qcL_T = (sel, t = 700, cN = 'is-active', mN = 'toggle') => {
	q(sel).classList[mN](cN)
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  console.log('🚀 ~ file: shortJS.js ~ line 204 ~ scrTT', q(sel))
...
const methods = { Id, oe, qcL, qcLm, ocL, ocLm }
